...
public partial class admin2_1_1_1 : System.Web.UI.Page
{
    ...
    {
       // Label3.Text = Session["TeacherID3"].ToString() + ":" + Session["TeacherName3"].ToString();
        Label6.Text = "&nbsp;&nbsp;&nbsp;&nbsp;当前修改" + ":" + Session["TeacherID3"].ToString() + Session["TeacherName3"].ToString(); 
    ...
    {
        Response.Redirect("Admin_Stu_Instruct_Paper.aspx");
    }
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        if(TextBox1.Text.Length!=0)
        {
            ...
            sql += ",[总课时]='" + TextBox3.Text + "',[年度]='" + TextBox4.Text + "',[状态]='" + DropDownList1 .Text + "'";
            sql += "where[工号]='" + Session["TeacherID3"].ToString() + "'and [学号]='" + TextBox1.Text + "'";
