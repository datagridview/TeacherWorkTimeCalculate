<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Stu_Project_Info.aspx.cs" Inherits="user2_3_2" %>
...
<body>
    ...
    <form id="form2" runat="server">
                       ...
                       &nbsp;  &nbsp; &nbsp; &nbsp;<asp:Label ID="Label11" runat="server" class="auto-style23" style="font-family:SimHei;font-size:medium;color:#040404" Text="毕业论文"></asp:Label> &nbsp;
                        <asp:Label ID="Label15" runat="server" class="auto-style24" style="font-family:SimHei;font-size:medium;color:#040404" Text="学生实习"></asp:Label>&nbsp;
        <asp:Label ID="Label12" runat="server" class="auto-style24" style="font-family:SimHei;font-size:medium;color:#0066FF" Text="项目实践"></asp:Label>
