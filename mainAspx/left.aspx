     ...
     <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav">
                    ...
                    <li>
                        <a href="admin1.aspx" target="right" style="color:white"><i class="fa fa-dashboard"></i> 日常生活<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="admin1.aspx" class="active" target="right" style="color:white"> 课程信息审核</a>
                            </li>
                            <li>
                                <a href="admin2-1.aspx" target="right" style="color:white"> 学生指导审核</a>
                            </li>
                            <li>
                                <a href="admin3-1.aspx" target="right" style="color:white"> 事务服务审核</a>
                            </li>
                        </ul>
                    </li>
                    <li>
