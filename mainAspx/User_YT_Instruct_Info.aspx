<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_YT_Instruct_Info.aspx.cs" Inherits="User_YT_Instruct_Info" %>
...
<body>
    ...
    <form id="form2" runat="server">
                       ...
                       &nbsp;  &nbsp; &nbsp; &nbsp;<asp:Label ID="Label10" runat="server" class="auto-style23" style="font-family:SimHei;font-size:medium;color:#040404" Text="素质文化讲座"></asp:Label> &nbsp;
                        <asp:Label ID="Label11" runat="server" class="auto-style24" style="font-family:SimHei;font-size:medium;color:#0066FF" Text="青年教师指导"></asp:Label>



        <div style="margin:0 150px">

                                    <asp:Label ID="Label12" runat="server" style="font-family:SimHei;font-size:12px;color:#040404;" >&nbsp;&nbsp;素质文化讲座审核状况</asp:Label> <br />                                     
