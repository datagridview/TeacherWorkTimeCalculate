<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user3-2-1.aspx.cs" Inherits="user3_2_1" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="auto-style15">
                                    <asp:Button ID="Button1" runat="server" class="auto-style25" BorderWidth="0px" OnClick="Button1_Click" Text="返回" /> 
                                </div>
                            </td>                            
                        </tr>                   
                    </table>                                                                
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="auto-style19">
                                <div class="auto-style15">
                                    <asp:Button ID="Button2" runat="server" class="auto-style25" BorderWidth="0px" OnClick="Button2_Click" Text="修改" /> 
                                </div>
                            </td>                            
                        </tr>                   
                    </table>  
                    <div class="auto-style21">
                        <asp:Label ID="Label5" runat="server" class="auto-style20" Width="100px">&nbsp;&nbsp;青年教师姓名：</asp:Label>
                        <asp:TextBox ID="TextBox1" runat="server" Width="300px" ReadOnly="False"></asp:TextBox>
                    </div>
                    <div class="auto-style21">
                        <asp:Label ID="Label6" runat="server" class="auto-style20" Width="100px">&nbsp;&nbsp;总课时：</asp:Label>
                        <asp:TextBox ID="TextBox2" runat="server" Width="300px" ReadOnly="False"></asp:TextBox>
                    </div>
                    <div class="auto-style21">
                        <asp:Label ID="Label7" runat="server" class="auto-style20" Width="100px">&nbsp;&nbsp;填写状态：</asp:Label>
                        <asp:TextBox ID="TextBox3" runat="server" Width="300px" ReadOnly="False">什么意思？不清楚</asp:TextBox>
                    </div>
                    <div class="auto-style21">
