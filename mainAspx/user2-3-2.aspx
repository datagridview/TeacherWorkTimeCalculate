<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user2-3-2.aspx.cs" Inherits="user2_3_2" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width:100%">
              <tr style="text-align:center;height:30px">
                    <td style="width:40%">
                       <asp:Label ID="Label17" runat="server" style="font-family:'SimHei';font-size:12px;color:#040404" Text="·毕业论文"></asp:Label>
                       <asp:Label ID="Label18" runat="server" style="font-family:'SimHei';font-size:12px;color:#040404" Text="·学生实习"></asp:Label>
                       <asp:Label ID="Label19" runat="server" style="font-family:'SimHei';font-size:12px;color:#0066FF" Text="·项目实践"></asp:Label>
                     </td>
                    <td></td>
                </tr>
        </table>
         ...
         <div class="auto-style6">
            <div class="auto-style7">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="auto-style15">
                                    <asp:Button ID="Button1" runat="server" class="auto-style17" BorderWidth="0px" 
                ...
                <div class="auto-style16">
                    ...
                    <div class="auto-style21">
                        <table><tr>
                       <td style ="width:150px">&nbsp;&nbsp;<asp:Label ID="Label8" runat="server" class="auto-style20">&nbsp;&nbsp;项目名称：&nbsp;&nbsp;</asp:Label></td>
