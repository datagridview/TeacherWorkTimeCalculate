...
public partial class admin3_1_1_1 : System.Web.UI.Page
{
    ...
    {
        TextBox1.Text = GridView1.Rows[GridView1.SelectedIndex].Cells[2].Text.ToString();
        TextBox2.Text = GridView1.Rows[GridView1.SelectedIndex].Cells[3].Text.ToString();
        TextBox3.Text = GridView1.Rows[GridView1.SelectedIndex].Cells[4].Text.ToString();
        TextBox4.Text = GridView1.Rows[GridView1.SelectedIndex].Cells[5].Text.ToString();
    }
   /* protected void Button2_Click(object sender, EventArgs e)
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (TextBox1.Text.Length != 0)
        {
            ...
            sql += ",[年度]='" + TextBox3.Text + "',[总课时]='" + TextBox4.Text + "',[状态]='" + DropDownList1.Text + "'";
            sql += "where[工号]='" + Session["TeacherID6"].ToString() + "'and [青年教师工号]='" + TextBox1.Text + "'";
            Response.Write(sql);
