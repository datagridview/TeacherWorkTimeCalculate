<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Lecture_State.aspx.cs" Inherits="User_Lecture_State" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin:0 150px">
            ...
            <asp:Label ID="Label1" runat="server" style="font-family:SimHei;font-size:medium;color:#080a58" Text="" TabIndex="22"></asp:Label>
        <div class="form-group">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-1"></div>
                    <div class="col-lg-1"></div>
                    <div class="col-lg-1"><asp:Button ID="Button2" runat="server" Text="修改" OnClick="Button2_Click"  CssClass="btn btn-primary" TabIndex="9"/></div>
                    <div class="col-lg-1"></div>
                    <div class="col-lg-1"></div>
                    <div class="col-lg-1"></div>
                    <div class="col-lg-1"></div>
