<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Stu_Practice.aspx.cs" Inherits="user2_2_1" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="User_Stu_Thesis.aspx"><asp:Label ID="Label17" runat="server"  style="font-family:'SimHei';font-size:medium;color:#040404" Text="毕业论文" ForeColor="Aqua"></asp:Label></a>&nbsp; 
                         <a href="User_Stu_Practice.aspx"><asp:Label ID="Label18" runat="server"  style="font-family:'SimHei';font-size:medium;color:#0066FF" Text="学生实习"></asp:Label></a>&nbsp;
