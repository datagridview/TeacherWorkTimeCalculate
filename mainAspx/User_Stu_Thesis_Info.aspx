<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Stu_Thesis_Info.aspx.cs" Inherits="user2_1_2" %>
...
<body>
    ...
    <form id="form2" runat="server">
                       ...
                       &nbsp;  &nbsp; &nbsp; &nbsp;<asp:Label ID="Label11" runat="server" class="auto-style23" style="font-family:SimHei;font-size:medium;color:#0066FF" Text="毕业论文"></asp:Label> &nbsp;
