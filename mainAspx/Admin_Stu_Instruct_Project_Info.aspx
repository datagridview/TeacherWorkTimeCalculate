<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Stu_Instruct_Project_Info.aspx.cs" Inherits="admin2_3_1_1" %>
  ...
  <div id="page-inner">
    ...
    <form id="form1" runat="server">
             ...
             <div class="auto-style100">
                 ...
                 <asp:Label ID="Label5" runat="server" style="font-family:SimHei;font-size:medium;color:#0066FF" Text="项目实践" TabIndex="4"></asp:Label>
                 </div>
        <br />
        ...
        <div style="margin:0 150px">
            ...
            &nbsp;
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered table-hover dataTable no-footer" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" AllowPaging="True" PageSize="6" Font-Size="12px" HorizontalAlign="Center" TabIndex="8">
                <Columns>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="TextBox1" runat="server" Width="200px" CssClass="form-control"/> 
                ...
                <asp:TextBox ID="TextBox2" runat="server" Width="200px" CssClass="form-control"/> 
                 ...
                 <br />
            <asp:Label runat="server" Font-Size="Medium">项目名称 </asp:Label>
