...
public partial class User_Lecture_State : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        sql += "[讲座名称]='" + Session["JName"].ToString() + "'";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        sql += "where [工号]='" + Session["TeacherID"].ToString() + "'and[讲座名称]='" + Session["JName"].ToString() + "'";
    ...
    {
        Response.Redirect("User_Lecture.aspx");
    }
}