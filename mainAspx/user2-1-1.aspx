<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user2-1-1.aspx.cs" Inherits="user2_1_1" %>
    ...
    <div class="auto-style1">
        ...
        <table style="width:100%">
              <tr style="text-align:center;height:30px">
                    <td style="width:40%">
                         <a href="user2-1-1.aspx"><asp:Label ID="Label17" runat="server"  style="font-family:'SimHei';font-size:12px;color:#0066FF" Text="·毕业论文" ForeColor="Aqua"></asp:Label></a>&nbsp; 
                         ...
                         <a href="user2-3-1.aspx"><asp:Label ID="Label19" runat="server"  style="font-family:'SimHei';font-size:12px;color:#040404" Text="·项目实践"></asp:Label></a>
                     </td>
                    <td></td>
                </tr>
        </table>
         ...
         <div class="auto-style6">
            <div class="auto-style7">
                ...
                <asp:GridView ID="GridView1" runat="server" Width="885px" AllowPaging="True" PageSize="5" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" Font-Size="12px" HorizontalAlign="Center">
